...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/quiet-butterfly-d656#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/quiet-butterfly-d656
```

A live public deployment of this template is available at [https://quiet-butterfly-d656.templates.workers.dev](https://quiet-butterfly-d656.templates.workers.dev)
